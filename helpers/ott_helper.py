...
def get_ott_negative_deceptive_colored():
    try:
        ...
        ott_negative_deceptive_colored = pd.read_csv(path, encoding='utf-8', sep=',', engine='python')
    except FileNotFoundError:
        path = './local_datasets/deceptive_negative_colored.csv'
        ott_negative_deceptive_colored = pd.read_csv(path, encoding='utf-8', sep=",", engine='python')

    return ott_negative_deceptive_colored
...
def get_ott_negative_truthful_colored():
    try:
        path = '../local_datasets/truthful_negative_colored.csv'
        ott_negative_truthful_colored = pd.read_csv(path, encoding='utf-8', sep=',', engine='python')
    except FileNotFoundError:
        path = './local_datasets/truthful_negative_colored.csv'
        ott_negative_truthful_colored = pd.read_csv(path, encoding='utf-8', sep=",", engine='python')

    return ott_negative_truthful_colored


def get_ott_positive_truthful_colored():
    try:
        path = '../local_datasets/truthful_positive_colored.csv'
        ott_positive_truthful_colored = pd.read_csv(path, encoding='utf-8', sep=',', engine='python')
    except FileNotFoundError:
        path = './local_datasets/truthful_positive_colored.csv'
        ott_positive_truthful_colored = pd.read_csv(path, encoding='utf-8', sep=",", engine='python')

    return ott_positive_truthful_colored
